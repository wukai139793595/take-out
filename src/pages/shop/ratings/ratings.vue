      ...
      <div class="overview">
        ...
        <div class="overview-right">
          <div class="score-wrapper">
            ...
            <rating :score="shopInfo.serviceScore" :size="36" />
            <span class="score">{{ shopInfo.serviceScore }}</span>
          </div>
          <div class="score-wrapper">
            <span class="title">商品评分</span>
            <rating :score="shopInfo.foodScore" :size="36" />
          ...
          >
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                <rating :score="rating.score" :size="24" />
...
import Rating from "@/components/shopList/rating/rating.vue";
...
export default {
  ...
  mounted() {
    this.$store.dispatch("shop/receiveShopRatings", () => {
      this.$nextTick(() => {
